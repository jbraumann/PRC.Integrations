...
export class GetRobotDataRequest extends jspb.Message {
  ...
  getExcludeGeometry(): boolean;
  setExcludeGeometry(value: boolean): GetRobotDataRequest;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): GetRobotDataRequest.AsObject;
  static toObject(includeInstance: boolean, msg: GetRobotDataRequest): GetRobotDataRequest.AsObject;
  static serializeBinaryToWriter(message: GetRobotDataRequest, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): GetRobotDataRequest;
  static deserializeBinaryFromReader(message: GetRobotDataRequest, reader: jspb.BinaryReader): GetRobotDataRequest;
}

export namespace GetRobotDataRequest {
  export type AsObject = {
    id: string,
...
export class GetRobotDataReply extends jspb.Message {
  getStatus(): string;
  setStatus(value: string): GetRobotDataReply;

  getRobotData(): Robot | undefined;
  setRobotData(value?: Robot): GetRobotDataReply;
  hasRobotData(): boolean;
  clearRobotData(): GetRobotDataReply;

  getRobotSettings(): Settings | undefined;
  setRobotSettings(value?: Settings): GetRobotDataReply;
  hasRobotSettings(): boolean;
  clearRobotSettings(): GetRobotDataReply;

  getVariables(): VariableArray | undefined;
  setVariables(value?: VariableArray): GetRobotDataReply;
  hasVariables(): boolean;
  clearVariables(): GetRobotDataReply;

  getAxisPosition(): JointTarget | undefined;
  setAxisPosition(value?: JointTarget): GetRobotDataReply;
  hasAxisPosition(): boolean;
  clearAxisPosition(): GetRobotDataReply;

  getToolFrame(): Matrix4x4 | undefined;
  setToolFrame(value?: Matrix4x4): GetRobotDataReply;
  hasToolFrame(): boolean;
  clearToolFrame(): GetRobotDataReply;

  getFlangeFrame(): Matrix4x4 | undefined;
  setFlangeFrame(value?: Matrix4x4): GetRobotDataReply;
  hasFlangeFrame(): boolean;
  clearFlangeFrame(): GetRobotDataReply;

  getRobotTransformationsList(): Array<TransformationArray>;
  setRobotTransformationsList(value: Array<TransformationArray>): GetRobotDataReply;
  clearRobotTransformationsList(): GetRobotDataReply;
  addRobotTransformations(value?: TransformationArray, index?: number): TransformationArray;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): GetRobotDataReply.AsObject;
  static toObject(includeInstance: boolean, msg: GetRobotDataReply): GetRobotDataReply.AsObject;
  static serializeBinaryToWriter(message: GetRobotDataReply, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): GetRobotDataReply;
  static deserializeBinaryFromReader(message: GetRobotDataReply, reader: jspb.BinaryReader): GetRobotDataReply;
}

export namespace GetRobotDataReply {
  export type AsObject = {
    status: string,
    robotData?: Robot.AsObject,
    robotSettings?: Settings.AsObject,
    variables?: VariableArray.AsObject,
...
export class GetSimulatedRobotStateRequest extends jspb.Message {
  ...
  getOmitVariables(): boolean;
  setOmitVariables(value: boolean): GetSimulatedRobotStateRequest;
...
export class CustomRobot extends jspb.Message {
  ...
  setPresetRobotClass(value: string): CustomRobot;
...
export namespace CustomRobot {
  ...
  export enum RootCsCase { 
    _ROOT_CS_NOT_SET = 0,
    ROOT_CS = 9,
  }

  export enum FlangeCsCase { 
    _FLANGE_CS_NOT_SET = 0,
    FLANGE_CS = 10,
  }
...
export class InsertCode extends jspb.Message {
  ...
  setIsComment(value: boolean): InsertCode;
...
export class Robot extends jspb.Message {
  ...
  getCellGeometry(): PolyMesh | undefined;
  setCellGeometry(value?: PolyMesh): Robot;
  hasCellGeometry(): boolean;
  clearCellGeometry(): Robot;
...
export namespace Robot {
  export type AsObject = {
    ...
    cellGeometry?: PolyMesh.AsObject,
    data?: MetaData.AsObject,
  }
...
export class SimulationResultUnit extends jspb.Message {
  ...
  setMotionType(value: string): SimulationResultUnit;
...
export class Tool extends jspb.Message {
  ...
  getToolRobotVariable(): string;
  setToolRobotVariable(value: string): Tool;
