...
class GetRobotDataRequest(_message.Message):
    ...
    ID_FIELD_NUMBER: _ClassVar[int]
    EXCLUDE_GEOMETRY_FIELD_NUMBER: _ClassVar[int]
    id: str
    exclude_geometry: bool
    def __init__(self, id: _Optional[str] = ..., exclude_geometry: bool = ...) -> None: ...

class GetRobotDataReply(_message.Message):
    __slots__ = ("status", "robot_data", "robot_settings", "variables", "axis_position", "tool_frame", "flange_frame", "robot_transformations")
    STATUS_FIELD_NUMBER: _ClassVar[int]
    ROBOT_DATA_FIELD_NUMBER: _ClassVar[int]
    ROBOT_SETTINGS_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, status: _Optional[str] = ..., robot_data: _Optional[_Union[Robot, _Mapping]] = ..., robot_settings: _Optional[_Union[Settings, _Mapping]] = ..., variables: _Optional[_Union[VariableArray, _Mapping]] = ..., axis_position: _Optional[_Union[JointTarget, _Mapping]] = ..., tool_frame: _Optional[_Union[Matrix4x4, _Mapping]] = ..., flange_frame: _Optional[_Union[Matrix4x4, _Mapping]] = ..., robot_transformations: _Optional[_Iterable[_Union[TransformationArray, _Mapping]]] = ...) -> None: ...

class GetSimulatedRobotStateRequest(_message.Message):
    __slots__ = ("id", "normalized_state", "stream_update", "omit_variables")
    ID_FIELD_NUMBER: _ClassVar[int]
    ...
    stream_update: bool
    omit_variables: bool
    def __init__(self, id: _Optional[str] = ..., normalized_state: _Optional[float] = ..., stream_update: bool = ..., omit_variables: bool = ...) -> None: ...
...
class InsertCode(_message.Message):
    __slots__ = ("code", "is_comment")
    CODE_FIELD_NUMBER: _ClassVar[int]
    IS_COMMENT_FIELD_NUMBER: _ClassVar[int]
    code: _containers.RepeatedScalarFieldContainer[str]
    is_comment: bool
    def __init__(self, code: _Optional[_Iterable[str]] = ..., is_comment: bool = ...) -> None: ...
...
class Robot(_message.Message):
    __slots__ = ("preset_robot_class", "custom_robot", "robot_driver_class", "friendly_id", "tool_dictionary", "initial_base", "collision_geometry", "external_axes", "cell_geometry", "data")
    ...
    CELL_GEOMETRY_FIELD_NUMBER: _ClassVar[int]
    DATA_FIELD_NUMBER: _ClassVar[int]
    preset_robot_class: str
    ...
    cell_geometry: PolyMesh
    data: MetaData
    def __init__(self, preset_robot_class: _Optional[str] = ..., custom_robot: _Optional[_Union[CustomRobot, _Mapping]] = ..., robot_driver_class: _Optional[str] = ..., friendly_id: _Optional[str] = ..., tool_dictionary: _Optional[_Mapping[str, Tool]] = ..., initial_base: _Optional[_Union[Base, _Mapping]] = ..., collision_geometry: _Optional[_Iterable[_Union[PolyMesh, _Mapping]]] = ..., external_axes: _Optional[_Iterable[_Union[ExternalAxis, _Mapping]]] = ..., cell_geometry: _Optional[_Union[PolyMesh, _Mapping]] = ..., data: _Optional[_Union[MetaData, _Mapping]] = ...) -> None: ...
...
class SimulationResultUnit(_message.Message):
    ...
    alarm: bool
    motion_type: str
    def __init__(self, axis_values: _Optional[_Iterable[float]] = ..., position: _Optional[_Union[Matrix4x4, _Mapping]] = ..., time: _Optional[float] = ..., collision: _Optional[_Iterable[bool]] = ..., singularity: _Optional[_Iterable[bool]] = ..., outofreach: _Optional[_Iterable[bool]] = ..., external_axis_values: _Optional[_Iterable[float]] = ..., external_axis_outofreach: _Optional[_Iterable[bool]] = ..., interpolation_factor: _Optional[float] = ..., id: _Optional[str] = ..., alarm: bool = ..., motion_type: _Optional[str] = ...) -> None: ...
...
class Tool(_message.Message):
    __slots__ = ("tool_type", "tcp", "tool_id", "tool_geometry", "tool_robot_variable")
    TOOL_TYPE_FIELD_NUMBER: _ClassVar[int]
    TCP_FIELD_NUMBER: _ClassVar[int]
    TOOL_ID_FIELD_NUMBER: _ClassVar[int]
    TOOL_GEOMETRY_FIELD_NUMBER: _ClassVar[int]
    TOOL_ROBOT_VARIABLE_FIELD_NUMBER: _ClassVar[int]
    tool_type: FrameType
    tcp: CartesianPosition
    tool_id: str
    tool_geometry: PolyMesh
    tool_robot_variable: str
    def __init__(self, tool_type: _Optional[_Union[FrameType, str]] = ..., tcp: _Optional[_Union[CartesianPosition, _Mapping]] = ..., tool_id: _Optional[str] = ..., tool_geometry: _Optional[_Union[PolyMesh, _Mapping]] = ..., tool_robot_variable: _Optional[str] = ...) -> None: ...
